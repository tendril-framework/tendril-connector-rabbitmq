...
``tendril-connector-rabbitmq`` can be installed normally from the Python Package Index.
...
.. code-block:: console
    ...
    $ pip install tendril-connector-rabbitmq
...
`github releases <https://github.com/tendril-framework/tendril-connector-rabbitmq/releases>`_.
...
``tendril-connector-rabbitmq``. ``sudo`` may be necessary if you are not installing
into a virtual environment.

.. code-block:: console

    $ git clone https://github.com/tendril-framework/tendril-connector-rabbitmq.git
    $ cd tendril-connector-rabbitmq
    $ pip install -e .
