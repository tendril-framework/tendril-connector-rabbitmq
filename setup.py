...
setup(
    ...
    description="RabbitMQ Connector for Tendril",
    long_description='\n'.join([read('README.rst'), read('CHANGELOG.rst')]),
    long_description_content_type='text/x-rst',
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-connector-rabbitmq',
    project_urls={
        'Documentation': 'https://tendril-connector-rabbitmq.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-connector-rabbitmq/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-connector-rabbitmq',
    },
